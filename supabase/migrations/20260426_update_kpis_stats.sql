-- =============================================
-- Migration: Update KPIs in get_athlete_planning_stats
-- 1. Adherence: 180 days
-- 2. Avg PSE: 180 days
-- 3. Current Workload: Remove
-- 4. Weekly Freq: 180 days / 26 weeks
-- 5. Ignore "Descanso" sessions in all KPI calculations
-- =============================================
